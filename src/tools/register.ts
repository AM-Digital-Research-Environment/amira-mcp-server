...
/** Register every AMIRA tool on the server, grouped by domain (23 tools). */
export function registerTools(server: Server): void {
  ...
  registerFacetTools(server); // list_subjects, list_locations, list_collections, list_categories
